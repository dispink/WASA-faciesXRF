...
lr_pca_df.to_csv('{}results/roll_pca+lr_grid_ss_{}.csv'.format(path, date))

from joblib import dump, load
dump(grid.best_estimator_, '{}models/roll_pca+lr_model_ss_{}.joblib'.format(path, date)) 
...
lr_df.to_csv('{}results/roll_lr_grid_ss_{}.csv'.format(path, date))

dump(grid.best_estimator_, '{}models/roll_lr_model_ss_{}.joblib'.format(path, date)) 
