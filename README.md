...
7. Update the database (three tables: elemental intensities, spetra, and infos) due to the update of composite depth. `update_database.ipynb`. Data length: 170436
